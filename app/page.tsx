...
import { TypewriterEffectSmoothDemo } from "../components/home/typewriter";

export default function Home() {
  return (
    <div className="w-full bg-black flex flex-col items-center justify-center pt-60 overflow-hidden ">
